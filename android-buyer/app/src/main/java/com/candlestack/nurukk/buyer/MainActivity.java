...
/**
 * Creates FCM notification channels before the WebView boots so pushes can
 * display when the app is backgrounded or killed (before any JS runs).
 */
public class MainActivity extends BridgeActivity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    try {
      ...
      Log.e("MainActivity", "Razorpay plugin register failed", t);
    }
  }
